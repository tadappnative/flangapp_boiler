...
class Config {
  ...
  /// Generated by SiteNative 11-06-2022 05:52:09
  /// App UID: e137bc81-ecb6-6ccb-f70f-55b1581a8674
  ...
  // App link
  static String appLink = "https://elzero.org/";
  ...
  // Background color (any HEX color)
  static String splashBackgroundColor = "#0AD561";
  ...
  // Signing
  static String osSigning = "da8276f175c13f9a50071bfe0f4c1960b0f9be1bc0eb22f45e1045c14001ba51";
  // Enabled android?
  ...
  // Back
  static String backBtn = "الرجوع الي الخلف";

  /// *** Navigation *** ///
  // Main app navigation
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "المقالات التعليمية",icon: "analytics-outline.svg",type: ActionType.internal,value: "https://elzero.org/category/topics",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "تعلم الان مجانا ",icon: "accessibility.svg",type: ActionType.internal,value: "https://elzero.org/category/topics",),

  ];
  // Modal navigation
  static List<NavigationItem> modalNavigation = [
    	NavigationItem(name: "ماهو الجديد",icon: "albums-outline.svg",type: ActionType.internal,value: "https://elzero.org/category/topics",),
