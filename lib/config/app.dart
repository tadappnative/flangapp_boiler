...
class Config {
  ...
  /// Generated by SiteNative 11-06-2022 04:06:38
  /// App UID: 5676dabf-d30a-ba41-eae1-253d0293ceee
  ...
  // App link
  static String appLink = "https://demo.flangapp.com/#/admin/customers";
  ...
  // Signing
  static String osSigning = "e044b86f3899dcacad1f2900278fe6b2eb2ed63ec8128db6eb2609b3e77d1b07";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "รรรร",icon: "albums-outline.svg",type: ActionType.internal,value: "https://codecanyon.net/",),
