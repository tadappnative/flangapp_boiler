...
class Config {
  ...
  /// Generated by SiteNative 11-06-2022 11:12:34
  /// App UID: 1fdbcdc1-446f-22fb-8333-cd0432ec438d
  ...
  // App link
  static String appLink = "https://codecanyon.net/item/flangapp-saas-online-app-builder-from-website/38131466";
  ...
  // Signing
  static String osSigning = "8ac3d8046e0407210382f230faae8969c4d9c33cb767cc659cc3f4f1a9fbf4a6";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Home",icon: "airplane.svg",type: ActionType.internal,value: "https://codecanyon.net/item/flangapp-saas-online-app-builder-from-website/screenshots/38131466?_ga=2.189988779.1235263287.1654959762-215408483.1654959762",),
	NavigationItem(name: "Community",icon: "archive.svg",type: ActionType.internal,value: "https://codecanyon.net/item/flangapp-saas-online-app-builder-from-website/full_screen_preview/38131466?_ga=2.122787595.1235263287.1654959762-215408483.1654959762",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "bvivewv",icon: "arrow-down-circle.svg",type: ActionType.internal,value: "https://codecanyon.net/item/flangapp-saas-online-app-builder-from-website/full_screen_preview/38131466?_ga=2.122787595.1235263287.1654959762-215408483.1654959762",),

  ];
  // Modal navigation
  static List<NavigationItem> modalNavigation = [
    	NavigationItem(name: "jvlkjv",icon: "accessibility.svg",type: ActionType.internal,value: "https://codecanyon.net/item/flangapp-saas-online-app-builder-from-website/full_screen_preview/38131466?_ga=2.122787595.1235263287.1654959762-215408483.1654959762",),
